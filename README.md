...
*   Get Flash Deals List
*   Get Item Detail
*   Get Search Result
*   Get Categories
*   Get Freight Countries
*   Get Freight Calculation

## Usage

### Get [Flash Deals](https://flashdeals.aliexpress.com/en.htm) List

```javascript
var AliExpressSpider = require('aliexpress');

AliExpressSpider.FlashDeals.get().then(function(goods){
  console.log('Flash Deals items:', goods);
});
```
...
```javascript
{
  ...
  productTitle: 'Bastec USB Data Charger Cable Nylon Braided Wire Metal Plug Micro USB Cable for iPhone 6 6s Plus 5s 5 iPad mini Samsung Sony HTC',
  gallery:
